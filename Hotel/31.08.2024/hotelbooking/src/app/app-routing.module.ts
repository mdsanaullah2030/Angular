...
const routes: Routes = [
  ...
  {path:'view',component:ViewlocationComponent,canActivate:[AuthGuard,RoleGuard],data: { role: 'User' }},
  {path:'create',component:CreatelocationComponent ,canActivate:[AuthGuard,RoleGuard],data: { role: 'Admin' }},
  {path:'updateLocation/:id',component:UpdatelocationComponent,canActivate:[AuthGuard],data: { role: 'Admin' }},
  {path:'hotelview',component:ViewhotelComponent,canActivate:[AuthGuard,RoleGuard],data: { role: 'User' }},
  {path:'createHotel',component:CreatehotelComponent,canActivate:[AuthGuard,RoleGuard],data: { role: 'Admin' }},
  {path:'updateHotel/:id',component:UpdatehotelComponent,canActivate:[AuthGuard,RoleGuard],data: { role: 'Admin' }},
  {path:'roomview',component:ViewroomComponent,canActivate:[AuthGuard,RoleGuard],data: { role: 'User' }},
  {path:'roomcreat',component:CreateroomComponent,canActivate:[AuthGuard,RoleGuard],data: { role: 'Admin' }},
  {path:'updateRoom/:id',component:UpdateroomComponent,canActivate:[AuthGuard,RoleGuard],data: { role: 'Admin' }},
  {path:'booking',component:ViewbookingComponent,canActivate:[AuthGuard,RoleGuard],data: { role: 'User' }},
  {path:'creat',component:CreatebookingComponent,canActivate:[AuthGuard,RoleGuard],data: { role: 'Admin' }},
  {path:'updateBooking/:id',component:UpdatebookingComponent,canActivate:[AuthGuard,RoleGuard],data: { role: 'Admin' }},
  {path:'about',component:AboutComponent},
  {path:'home',component:HomeComponent},
  {path:'reg',component:RegistrationComponent},
  {path:'login',component:LoginComponent},
  {path:'logout',component:LogoutComponent},
  {path: 'userprofile', component:UserprofileComponent,canActivate:[AuthGuard,RoleGuard],data: { role: 'Admin' }},
